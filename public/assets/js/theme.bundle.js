(()=>{
    var e, t = {
        ...
        444: (e,t,a)=>{
            ...
            !function() {
                if (n) {
                    const e = JSON.parse(m.showPopover) && "base" === m.sidebarSize
                      , t = new o.J2(n,{
                        offset: [0, 16],
                        placement: "top",
            ...
            function() {
                ...
                for (let t = 0; t < e.length; t++) {
                    const a = e[t].split("=")
                      , o = a[0]
                      , n = a[1];
                    "colorScheme" != o && "navPosition" != o && "navColor" != o && "sidebarSize" != o || (localStorage.setItem("dashkit" + o.charAt(0).toUpperCase() + o.slice(1), n),
                    m[o] = n)
                }
            }(),
            function(e) {
            ...
            function(e) {
                if (c && i && r) {
                    const t = "default" === e ? "" : "vibrant" === e ? "vibrant" : "light" === m.colorScheme ? "dark" : "light";
            ...
            }(l, m.colorScheme, m.navPosition, m.navColor, m.sidebarSize),
            p && y(m.navPosition),
        ...
        524: (e,t,a)=>{
            ...
            !function() {
                ...
                void 0 !== C() && e && [].forEach.call(e, (function(e) {
                    !function(e) {
                ...
                void 0 !== C() && t && [].forEach.call(t, (function(e) {
                    e.addEventListener("click", (function(e) {
                        e.preventDefault()
                    }
                    ))
            ...
            const E = document.querySelectorAll(".navbar .dropup, .navbar .dropend, .navbar .dropdown, .navbar .dropstart");
            ...
            q.kL.register(q.qi, q.vn, q.ZL, q.N0, q.uw, q.WY, q.jI, q.Gu, q.De, q.f$, q.ST, q.jn, q.WV, q.tt, q.od, q.CV, q.Xi, q.l7, q.ho, q.FB, q.RM, q.Dx, q.u);
            const D = {
                gray: {
            ...
            function J(e) {
                ...
                if (a.body) {
                    ...
                    n.forEach(((e,o)=>{
                        ...
                        s.style.backgroundColor = "line" === t.config.type && "rgba(0,0,0,0.1)" !== l.borderColor ? l.borderColor : l.backgroundColor;
                        const c = document.createElement("div");
                        c.classList.add("popover-body", "d-flex", "align-items-center", "text-nowrap"),
                        c.classList.add(n.length > 1 ? "justify-content-left" : "justify-content-center");
                ...
                o.style.transform = "translateX(-50%) translateY(-100%) translateY(-1rem)"
            }
            function P(e) {
                let t = "";
            ...
            q.kL.defaults.elements.line.tension = .4,
            ...
            q.kL.defaults.elements.arc.borderColor = x("--bs-chart-arc-border-color"),
            q.kL.defaults.elements.arc.borderWidth = 4,
            q.kL.defaults.elements.arc.hoverBorderColor = x("--bs-chart-arc-hover-border-color"),
            ...
            const R = document.querySelectorAll("#sparklineChartSocialOne, #sparklineChartSocialTwo, #sparklineChartSocialThree, #sparklineChartSocialFour");
    ...
    function o(e) {
        ...
        return t[e].call(l.exports, l, l.exports, o),
        l.exports
    }
    o.m = t,
    e = [],
        ...
        if (!a) {
            ...
            for (d = 0; d < e.length; d++) {
                for (var [a,n,l] = e[d], s = !0, c = 0; c < a.length; c++)
                    (!1 & l || r >= l) && Object.keys(o.O).every((e=>o.O[e](a[c]))) ? a.splice(c--, 1) : (s = !1,
                    l < r && (r = l));
                if (s) {
                    e.splice(d--, 1);
                    var i = n();
